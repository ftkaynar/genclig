      ...
      {stats ? (
        <section className="rounded-2xl border border-edge bg-card p-4">
          <h2 className="flex items-center gap-1.5 text-sm font-semibold text-ink">
            ...
            {stats.district_name}&apos;de
          </h2>

          <div className="mt-3 grid grid-cols-2 gap-2">
            <span className="rounded-xl bg-surface px-3 py-2.5 text-center">
          ...
          {stats.channel_id ? (
            <Link
              href="/topluluk"
              className="mt-3 flex items-center justify-center gap-1.5 rounded-full border border-edge px-4 py-2 text-xs font-semibold text-ink"
            >
